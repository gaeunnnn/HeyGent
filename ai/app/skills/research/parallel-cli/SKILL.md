...
- It is an external research integration and should be used only when Parallel is explicitly configured or requested.
...
Do not use this skill for quick one-off lookups unless Parallel is specifically requested and configured.
